...
function ItemProject2({title,urlCode,body,urlLive,skills}) {
            ...
            <div className="flex justify-start w-auto flex-col space-y-6 items-center">
               ...
               {body} </p> 
                            <div className="flex gap-4">
                                {
                                    skills.map((skill,i)=>{
                                        return <span key={i} className="font-medium text-[19px] p-2 bg-white  border-1 border-[#f9f9f9] shadow-md">{skill}</span>
                                    })
                                }
                </div>
                <div className="flex gap-9 pt-6">
                    <a href={urlCode} target="_blank" rel="noopener noreferrer" className=" flex justify-center items-center text-xl gap-2 hover:text-[#C938AF]">Code <BsGithub size={25} /></a>
                    <br />
                    <a href={urlLive} target="_blank" rel="noopener noreferrer" className="flex justify-center items-center text-xl gap-2 hover:text-[#C938AF]">Live Demo <HiOutlineExternalLink size={25} />
                    </a>
                </div>
            </div>
        </div>
